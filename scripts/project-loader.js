(function () {
  ...
  function normalizeProjectRegistry() {
    ...
    if (!separatedProjects.length) {
      window.PORTFOLIO_PROJECTS = normalizeProjectImageData(normalizeTextContent(legacyProjects));
      return;
    }
    ...
    window.PORTFOLIO_PROJECTS = normalizeProjectImageData(normalizeTextContent(mergedProjects));
  }
